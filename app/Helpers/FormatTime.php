...
class FormatTime {
    ...
    public static function LongTimeFilter($date, $min = false) {
        // se agregó el parámetro $min para que la primer letra venga en minúsucula
        if ($date == null) {
            return "Sin fecha";
        }
